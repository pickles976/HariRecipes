...
from src.service.templating import home_template, query_results_template, recipe_detail_template
...
async def recipe_query(query, num_items: str = "20"):
    ...
    return query_results_template(data, query, num_items)
...
async def recipe(index: int):
    ...
    return recipe_detail_template(list(recipes.values())[0], index)
